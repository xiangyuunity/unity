    ...
    SubShader {
        ...
        Pass 
		{
            ...
            fixed4 frag (v2f i) : SV_Target
            {
			  ...
			  float MaskTex = tex2D(_Mask, MainTexUV).r;		
			  // Apply Distorion in MainTex
			  float4 DistortedMainTex=tex2D(_Texture1, MainTexUV + lerp(FinalDistortion, float2(0.0, 0.0), MaskTex));
			  ...
			  float3 emission = lerp(reflection, half3(0.0, 0.0, 0.0), MaskTex);
